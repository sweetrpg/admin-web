...
/// convention as catalog-web and the Go services - see docs/service-conventions.md). Falls back
/// to placeholder values when the file doesn't exist (local `swift run`, outside a container).
